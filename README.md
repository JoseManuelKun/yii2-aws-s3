...
[![License](https://poser.pugx.org/josemanuelkun/yii2-aws-s3/license)](https://github.com/josemanuelkun/yii2-aws-s3/blob/2.x/LICENSE)
[![Latest Stable Version](https://poser.pugx.org/josemanuelkun/yii2-aws-s3/v/stable)](https://packagist.org/packages/josemanuelkun/yii2-aws-s3)
[![Total Downloads](https://poser.pugx.org/josemanuelkun/yii2-aws-s3/downloads)](https://packagist.org/packages/josemanuelkun/yii2-aws-s3)
[![Latest Unstable Version](https://poser.pugx.org/josemanuelkun/yii2-aws-s3/v/unstable)](https://packagist.org/packages/josemanuelkun/yii2-aws-s3)

> Yii2 AWS S3 uses [SemVer](http://semver.org/).

> Version 2.x requires PHP 7. For PHP less 7.0 use [1.x](https://github.com/josemanuelkun/yii2-aws-s3/tree/1.x).
...
2. Add the component to `config/main.php`
    ...
    'components' => [
        // ...
        's3' => [
            'class' => 'josemanuelkun\yii2\aws\s3\Service',
...
```php
/** @var \josemanuelkun\yii2\aws\s3\Service $s3 */
$s3 = Yii::$app->get('s3');
...
```php
/** @var \josemanuelkun\yii2\aws\s3\interfaces\Service $s3 */
$s3 = Yii::$app->get('s3');

/** @var \josemanuelkun\yii2\aws\s3\commands\GetCommand $command */
...
use josemanuelkun\yii2\aws\s3\base\commands\traits\Options;
use josemanuelkun\yii2\aws\s3\interfaces\commands\Command;
use josemanuelkun\yii2\aws\s3\interfaces\commands\HasBucket;
...
use josemanuelkun\yii2\aws\s3\base\handlers\Handler;
...
```php
/** @var \josemanuelkun\yii2\aws\s3\interfaces\Service */
$s3 = Yii::$app->get('s3');
...
use josemanuelkun\yii2\aws\s3\interfaces\commands\HasBucket;
use josemanuelkun\yii2\aws\s3\interfaces\commands\PlainCommand;
